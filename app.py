...
def main():
    ...
    with st.container():
        ...
        st.markdown("เลือกไฟล์ PDF หรือรูปภาพ (สามารถเลือกได้หลายไฟล์)")
        ...
        if uploaded_files:
            if st.button("เริ่มประมวลผล", type="primary"):
                ...
                if results:
                    ...
                    if "gcp_service_account" not in st.secrets:
                        st.warning("ไม่พบข้อมูลการเชื่อมต่อ Google Sheets ใน secrets.toml จึงไม่สามารถบันทึกข้อมูลได้")
